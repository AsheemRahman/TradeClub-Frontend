...
const EnhancedReviewSection = () => {
    ...
    const handleAddReview = async () => {
        ...
        try {
            ...
            await courseApi.addReview(courseId, { rating: userRating, comment: userComment, });
                                ...
                                {reviews.map((review, index) => (
                                    <div key={index} className="p-6 hover:bg-white/5 transition-colors duration-200">
                                        <div className="flex items-start space-x-4">
                                            {/* Avatar */}
                                            <div className="flex-shrink-0 relative w-15 h-15">
                                                <Image src={review.user.profilePicture} alt="Profile Photo" fill className="rounded-full object-cover shadow-lg" />
                                            </div>
