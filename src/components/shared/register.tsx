// components/shared/register.tsx
...
const RegisterPage: React.FC<RegisterPageProps> = ({ role, onRegister }) => {
                ...
                <div className="w-full md:w-1/2 p-8 md:p-8">
                    ...
                    <form className="flex flex-col gap-3" onSubmit={handleSubmit(onSubmit)}>
                        ...
                        <div className="relative">
                            <input type={showPassword ? 'text' : 'password'} placeholder="Enter your password" {...register("password", registerValidation.password)} className="w-full p-3 rounded bg-[#2D2A4A] text-white placeholder-gray-400 focus:outline-none" />
