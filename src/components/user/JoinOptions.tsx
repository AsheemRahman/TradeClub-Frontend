...
const TradeClubHero = () => {
    ...
    return (
        <div className="bg-[#0E0B19] text-white min-h-screen flex flex-col justify-center items-center py-16 px-4 md:px-12">
                ...
                <div className="flex flex-col justify-center items-center gap-16">
                    ...
                    >
                        ...
                        <motion.div
                            whileHover={{ scale: 1.03, rotate: -1 }}
                            transition={{ type: "spring", stiffness: 300 }}
                            className="relative w-48 h-48 overflow-hidden rounded-2xl shadow-2xl flex-shrink-0"
                        >
                            <div className="absolute inset-0 bg-gradient-to-tr from-[#ff5722]/70 to-[#ff9800]/50 mix-blend-overlay" />
                            <Image
