                ...
                <div className="grid lg:grid-cols-2 gap-12 items-center min-h-[85vh]">
                    ...
                    <div className="text-center lg:text-left">
                        ...
                        <div className="inline-flex items-center bg-gradient-to-r from-green-500/20 to-cyan-500/20 backdrop-blur-sm rounded-full px-4 py-2 mb-6 border border-green-500/30">
                            ...
                            <span className="text-sm text-green-300 font-medium">Trading Platform</span>
                        </div>
                        ...
                        <div className="flex flex-col sm:flex-row gap-4 mb-12">
                            <button onClick={() => router.push("/login")} className="bg-gradient-to-r from-cyan-500 to-purple-500 text-white px-8 py-4 rounded-full font-semibold text-lg hover:shadow-2xl hover:shadow-cyan-500/25 transform hover:-translate-y-1 transition-all duration-300 flex items-center justify-center group">
                                Start Trading Journey
                                <ChevronRight className="w-5 h-5 ml-2 group-hover:translate-x-1 transition-transform" />
                            </button>
                            <button onClick={() => router.push("/expert/login")} className="border-2 border-white/30 text-white px-8 py-4 rounded-full font-semibold text-lg hover:bg-white/10 transition-all duration-300 backdrop-blur-sm flex items-center justify-center group">
                                Join as Expert
